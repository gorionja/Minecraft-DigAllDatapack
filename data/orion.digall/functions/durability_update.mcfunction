...
execute if score @s DAD_USE_W_SVL matches 1 if score @s DAD_BRK_W_SVL matches 0 if score @s DAD_DURABILITY matches ..58 run loot replace entity @s weapon.mainhand mine ~ 255 ~ minecraft:diamond_pickaxe{replace_contents: true}
...
execute if score @s DAD_USE_S_SVL matches 1 if score @s DAD_BRK_S_SVL matches 0 if score @s DAD_DURABILITY matches ..130 run loot replace entity @s weapon.mainhand mine ~ 255 ~ minecraft:diamond_pickaxe{replace_contents: true}
...
execute if score @s DAD_USE_I_SVL matches 1 if score @s DAD_BRK_I_SVL matches 0 if score @s DAD_DURABILITY matches ..249 run loot replace entity @s weapon.mainhand mine ~ 255 ~ minecraft:diamond_pickaxe{replace_contents: true}
...
execute if score @s DAD_USE_G_SVL matches 1 if score @s DAD_BRK_G_SVL matches 0 if score @s DAD_DURABILITY matches ..31 run loot replace entity @s weapon.mainhand mine ~ 255 ~ minecraft:diamond_pickaxe{replace_contents: true}
...
execute if score @s DAD_USE_D_SVL matches 1 if score @s DAD_BRK_D_SVL matches 0 if score @s DAD_DURABILITY matches ..1560 run loot replace entity @s weapon.mainhand mine ~ 255 ~ minecraft:diamond_pickaxe{replace_contents: true}
