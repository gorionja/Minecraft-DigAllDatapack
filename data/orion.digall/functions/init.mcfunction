execute unless score first_time DAD_SETTING matches 11 run tellraw @a ["",{"text": "digall loaded. "},{"text": "["},{"text": "Open Setting", "color": "blue", "clickEvent": {"action": "run_command", "value": "/trigger DAD_SETTING_TRG set 157"}, "hoverEvent": {"action": "show_text", "value": "click"}},{"text": "] ", "color": "reset"},{"text": "(\u521d\u56de\u8aad\u8fbc)", "color": "gray"}]
execute if score first_time DAD_SETTING matches 11 run tellraw @a ["",{"text": "digall loaded. "},{"text": "["},{"text": "Open Setting", "color": "blue", "clickEvent": {"action": "run_command", "value": "/trigger DAD_SETTING_TRG set 158"}, "hoverEvent": {"action": "show_text", "value": "click"}},{"text": "]", "color": "reset"}]
