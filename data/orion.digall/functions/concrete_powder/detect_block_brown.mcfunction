...
execute at @e[type=minecraft:area_effect_cloud,sort=nearest,limit=1,tag=first_point] run function orion.digall:concrete_powder/div_move_destroy_pos_brown
